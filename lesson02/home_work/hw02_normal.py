...
# например, out_list = [1, 2, 4, 5, 6, 2, 5, 2], нужно получить out_list2 = [1, 2, 4, 5, 6]
# б) элементы исходного списка, которые не имеют повторений:
# например, out_list = [1 , 2, 4, 5, 6, 2, 5, 2], нужно получить out_list2 = [1, 4, 6]

def task4():
    print('# Задача-4')

    # а)
    out_list = [1, 2, 4, 5, 6, 2, 5, 2]
    out_list2 = list(set(out_list))
    print('Решение а: ', end='')
    print(out_list2)
